...
class Conference(BaseEntity):
    ...
    def __str__(self):
        return f"Conference(id={id(self)})"
...
class Publication(BaseEntity):
    ...
    def __str__(self):
        return f"Publication(id={id(self)}, main_author_id=({self.main_author_id})"
